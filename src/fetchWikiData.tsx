...
function fetchWikiData(year: string, month: string, day: string) {
    return axios.get(`https://wikimedia.org/api/rest_v1/metrics/pageviews/top/en.wikipedia/all-access/${year}/${month}/${day}`)
}
